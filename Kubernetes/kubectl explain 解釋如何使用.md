# ex
> `kubectl explain service.spec` : 解釋 在 service 下的 spec 是幹嘛用的
...
FIELDS:
   ...
   publishNotReadyAddresses	<boolean>
     ...
     readiness for purpose of peer discovery. This field will replace the
     service.alpha.kubernetes.io/tolerate-unready-endpoints when that annotation
     is deprecated and all clients have been converted to use this field.
